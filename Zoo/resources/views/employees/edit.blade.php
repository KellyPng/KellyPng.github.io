...
<style>
    ...
    <div class="container">
        ...
        <br>
        <form action="{{action('App\Http\Controllers\EmployeeController@update',$employee->id)}}" class="form" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="formconntainer">
                <div class="mb-3">
                    ...
                    <input type="text" id="fname" class=" @error('fname') is-invalid @enderror form-control"
                        name="fname" value="{{$employee->firstname}}" required autocomplete="fname" autofocus>
                    @error('fname')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="lname" class="@error('lname') is-invalid @enderror form-control"
                        name="lname" value="{{$employee->lastname}}" required autocomplete="lname" autofocus>
                    @error('lname')
                ...
                <div class="emptype mb-3">
                    ...
                    <select class="form-select form-control mt-0" aria-label="employeeType" id="emptype" name="emptype"
                        ...
                        <option value="Admin" {{ $employee->employeeType == 'Admin' ? 'selected' : '' }}>Admin</option>
                        <option value="Employee" {{ $employee->employeeType == 'Employee' ? 'selected' : '' }}>Employee</option>
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <input type="password" id="adminpass" class="@error('password') is-invalid @enderror form-control" name="password" autocomplete="new-password">
                    <span></span>
