...
@section('content')
    ...
    <div class="container">
        ...
        <p>Dear {{ $admin->firstname }},</p>
            ...
            <p>The ticket stated below has sold out.</p>
            ...
            <div class="ticket-info">
                ...
                <?php $ticketObject = \App\Models\TicketAvailability::find($notification->data['soldOutTicket']['id']); ?>
                <p><strong>Ticket Name:</strong> {{$ticketObject->ticketType->ticketTypeName}}</p>
                <p><strong>Sold Out Date:</strong> {{$notification->data['soldOutTicket']['date']}}</p>
                <p><strong>Current Capacity:</strong> {{$ticketObject->ticketType->capacity}}</p>
            </div>
            <br>

                <p>Click here to add more capacity for this ticket.</p>
                {{-- <a href="{{url('inventory')}}" class="btn viewbutton">Add Capacity</a> --}}
                <a href="{{ route('inventory_page', ['date' => $notification->data['soldOutTicket']['date'], 'active_tab' => 'tickets']) }}" class="btn viewbutton">Add Capacity</a>
                <br><br>
        <div class="footer">
